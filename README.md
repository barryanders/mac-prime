...
## [Apps](https://github.com/barryanders/mac-prime/tree/main/apps)

To install my apps, I use [`brewfile`](https://github.com/barryanders/mac-prime/blob/main/apps/brewfile) (an installable list of apps generated by and for [Homebrew](https://github.com/Homebrew/brew)). I rely almost exclusively on Homebrew to manage and update my apps. [Learn how to make your own brewfile](https://github.com/Homebrew/homebrew-bundle).

### Install Apps

Run [this script](https://github.com/barryanders/mac-prime/blob/main/apps/install.sh) to install the packages listed in the apps folder.
...
The [`.commands`](https://github.com/barryanders/mac-prime/tree/main/dotfiles/.commands) folder is intended for you to add and remove custom commands in a categorical way. Keep what you want. Refer to the [`template`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/template) file for a basic example of how to create your own commands.

Here's what I've got in there for you:

- [`$`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/%24): Reasonable Terminal defaults
- [`clean`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/clean): System maintenance
- [`dock`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/dock): Control your Dock
- [`download`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/download): Download links, music, and videos
- [`finder`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/finder): View files, get info, perform actions, extract, compress, etc.
- [`images`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/images): Batch resizing images
...
Customize your Dock with the [`dock`](https://github.com/barryanders/mac-prime/blob/main/dock) file. Use these commands:
...
Once you're done, run the [`dock`](https://github.com/barryanders/mac-prime/blob/main/dock) file and your Dock will be updated accordingly.

```bash
~//dock
```

## [Hosts](https://github.com/barryanders/mac-prime/blob/main/hosts)

Keep track of your hosts in the [`hosts`](https://github.com/barryanders/mac-prime/blob/main/hosts) file. I use [`update hosts`](https://github.com/barryanders/mac-prime/blob/main/dotfiles/.commands/update) to replace my system hosts file with this one.
